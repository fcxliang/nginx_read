...
ngx_event_move_posted_next(ngx_cycle_t *cycle)
{
    ...
    ngx_queue_add(&ngx_posted_events, &ngx_posted_next_events);  //把ngx_posted_next_events插入ngx_posted_events前面
    ngx_queue_init(&ngx_posted_next_events); //清空ngx_posted_next_events变量
}
