...
#define NGX_HTTP_VHOST_TRAFFIC_STATUS_UPSTREAM_FG          4  // filter group？
...
#define NGX_HTTP_VHOST_TRAFFIC_STATUS_KEY_SEPARATOR        (u_char) 0x1f  //单元分隔符
...
ngx_msec_int_t ngx_http_vhost_traffic_status_upstream_header_time(ngx_http_request_t *r); // holyzone
