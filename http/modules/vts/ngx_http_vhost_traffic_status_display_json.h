...
#define NGX_HTTP_VHOST_TRAFFIC_STATUS_JSON_FMT_MAIN "\"hostName\":\"%V\","     \
    "\"moduleVersion\":\"%s\","                                                \
    "\"nginxVersion\":\"%s\","                                                 \
    "\"generation\":\"%uA\","                                                  \  	//holyzone
    "\"handshakes\":\"%uA\","                                                  \	//holyzone
    "\"handshakes_failed\":\"%uA\","                                           \	//holyzone
    "\"session_reuses\":\"%uA\","                                              \	//holyzone
    "\"loadMsec\":%M,"                                                         \
    "\"nowMsec\":%M,"                                                          \
    "\"connections\":{"                                                        \
    "\"active\":%uA,"                                                          \
