...
typedef struct {
    ...
    //holyzone 统计upstream headertime
    //ngx_atomic_t                                           header_time_counter;
    ngx_msec_t                                             header_time;
    ngx_http_vhost_traffic_status_node_time_queue_t        header_times;
    ngx_http_vhost_traffic_status_node_histogram_bucket_t  header_buckets;
    //holyzone end 统计upstream headrtime
} ngx_http_vhost_traffic_status_node_upstream_t;


typedef struct {
    u_char                                                 color;
    u_char                                                 domain[128]; //holyzone
    ngx_atomic_t                                           stat_active; //holyzone
    ...
    //ngx_atomic_t                                           stat_header_time_counter_oc;  // holyzone
#if (NGX_HTTP_CACHE)
