...
//合并server中的filterkeys，lxl
ngx_int_t ngx_http_vhost_traffic_status_filter_merge(
    ngx_pool_t *pool, ngx_array_t **keys_merged, ngx_array_t *ckeys, ngx_array_t *pkeys);
